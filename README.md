...
## Project Title
Sweet Rise Bakery Website Development
...
The website includes a homepage that introduces the bakery and its services. There will be an about page that explains the background of the business. A services page will display both products and services offered. The enquiry page will provide a form where customers can enter their details and requests. The contact page will display contact information and location.

## Timeline and Milestones
Week 1: Research and planning of the project  
Week 2: Creation of proposal, wireframes and sitemap  
Week 3: Development of HTML structure  
...
Consistent colour palette implementation
Typography styling using CSS properties
Navigation styling and hover effects
Flexbox layout implementation
Responsive design using media queries
Improved spacing, alignment, and layout structure
...
Responsive layouts work effectively
